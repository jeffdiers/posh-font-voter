...
export default function EventPage() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto w-full px-4 py-8 pt-12 sm:px-36 sm:pt-24">
        {/* Event Content */}
        <div className="mx-auto mt-1 grid w-full grid-cols-1 items-start justify-start gap-6 lg:grid-cols-[450px_1fr]">
          {/* Event Flyer (Left) */}
          <div
            className="relative left-1/2 z-10 translate-x-[-50%]"
            style={{
