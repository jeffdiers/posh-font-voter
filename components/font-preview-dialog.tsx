          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-base">
                ...
                science of typography. From classic serifs to modern sans, we'll
                dive deep into what makes great typography work.
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-lg font-medium">Register Now & Save 20%</div>
            </div>
